'use client'
import { TeamCard, TeamCardInterface } from "@/components/TeamCard";
...
export default function Page() {
  ...
  return(
    <>
    <section id="teams-page" className="max-w-6xl flex flex-wrap justify-center self-center p-4 flex-col w-full items-center pt-32 pb-36">
