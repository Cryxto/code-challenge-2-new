...
function Hero() {
  return (
    ...
    //   />
    // </div>
    <div className='w-screen h-screen relative self-center  drop-shadow-2xl bg-black rounded-br-[20rem]'>
      <Image
        className='top-0 left-0 w-full h-screen object-cover rounded-br-[20rem]'
        src='https://images.unsplash.com/photo-1614451153744-0c4f015f4d68?q=80&w=1472&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
        alt='/'
        fill={true}
      />
      ...
      <div className='absolute top-0 w-full h-full flex flex-col justify-center text-white items-center '>
        <div className='max-w-[1100px] absolute p-4 m-4'>
          ...
          <p className='max-w-[600px] drop-shadow-2xl py-2 text-xl'>
            with the best quality , eco friendly and harmless to the environment material, so do the best quality of service and delivery
          </p>
